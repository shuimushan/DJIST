...
def parse_arguments():
    ...
    ##新加的layer1，可训练dinov2最后几层，之前我的方法layer1一直是11，也就是固定backbone，现在试试layer1为9也就是其他聚合方法用的
    parser.add_argument('--layer1', type=int, default=11)
    
    # dataset
    parser.add_argument("--city", type=str, default='', nargs='*', help='subset of cities from train set')
    parser.add_argument("--test_ds_city1", type=str, default='test', help='subset of cities from train set')
    parser.add_argument("--test_ds_city2", type=str, default='val', help='subset of cities from train set')
    parser.add_argument("--pca_dim", type=int, default=None, help='cricavpr/super-cricavpr evaluation')
    ...
    parser.add_argument("--threshold", type=float, default=0,
                        help="threshold for the triplet_me loss")
    parser.add_argument("--lambda_triplet", type=float, default=10000, help="weight to triplet loss")
    parser.add_argument("--lambda_triplet_me", type=float, default=10000, help="weight to triplet_me loss")
    ...
    parser.add_argument("--aggregation_type", type=str, default="seqgem",
                        choices=["concat", "mean", "max", "simplefc", "conv1d", "meanfc", "seqgem","seqvlad","temporal_mix","temporal_mix_lower_dim","super_cricavpr"], help="_")
