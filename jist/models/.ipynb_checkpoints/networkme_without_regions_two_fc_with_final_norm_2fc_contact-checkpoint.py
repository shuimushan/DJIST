...
class JistModelMe_without_regions_two_fc_with_final_norm_2fc_contact(nn.Module):
    ...
    def forward(self, x):
        x= self.model(x)
        #x1,x2 = x#仅为计算参数量和FLOPs
        #x2 = self.aggregate(x2)#仅为计算参数量和FLOPs
        return x
