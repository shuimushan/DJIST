...
class Me(nn.Module):
    ...
    def forward(self, x):
        ...
        return x_gem_fc,[x_gem,x_addition]
...
class JistModelMe_without_regions_two_fc_with_final_norm_with_additional_branch_same_gem(nn.Module):
    ...
    def aggregate(self, frames_features):
        ...
        if self.agg_type == "seqgem":
            #aggregated_features1 = self.gem1(frames_features[0])
