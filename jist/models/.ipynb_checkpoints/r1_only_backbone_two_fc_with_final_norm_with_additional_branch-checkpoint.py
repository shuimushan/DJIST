...
class Me(nn.Module):
    ...
    """
    def __init__(self, backbone_arch='only_backbone', pretrained=True, layer1=9, use_cls=False, norm_descs=True,out_indices=[8, 9, 10, 11],backbone_out_dim=768,mix_in_dim=768,token_num=2,token_ratio=1):
        super().__init__()
...
class R1_only_backbone_two_fc_with_final_norm_with_additional_branch(nn.Module):
