...
class GeMFc(nn.Module):
    ...
    def forward(self, x):
        ...
        x_gem_no_fc = F.normalize(x_gem_no_fc, p=2, dim=1)#这个normalize？
        
        return x_gem_no_fc,x_gem_no_fc
...
class JistModelMe_without_regions_only_final_fc(nn.Module):
