...
class JistModelMe_seqgem_with_final_norm_not_fc_continue_different_gem_gem512(nn.Module):
    def __init__(self, args, agg_type="concat"):
        ...
        if agg_type == "temporal_mix":#缺点是只能针对固定seq_len
            ...
            self.channel_proj = nn.Linear(self.fc_output_dim, 512)
