...
class JistModelMe_without_regions_two_fc_with_final_norm_3fc_contact(nn.Module):
    ...
    def aggregate(self, frames_features):
        ...
        if self.agg_type == "seqgem":
            aggregated_features1 = self.gem1(frames_features)
            ...
            aggregated_features2 = self.gem2(frames_features)
